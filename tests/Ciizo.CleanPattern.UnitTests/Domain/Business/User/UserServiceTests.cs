...
namespace Ciizo.CleanPattern.UnitTests.Domain.Business.User
{
    public class UserServiceTests
    {
        private IUserService _userService = null!;
        private Mock<IRepository<CleanPattern.Domain.Core.Entities.User, IApplicationDbContext>> _userRepositoryMock = null!;

        private void SetUp()
        {
            _userRepositoryMock = new Mock<IRepository<CleanPattern.Domain.Core.Entities.User, IApplicationDbContext>>();
        ...
        public async Task GetUserAsync_IdNotFound_ThrowDataNotFoundException()
        {
            ...
            _userRepositoryMock.Setup(x => x.GetByIdAsync(It.IsAny<Guid>(), CancellationToken.None))
                .ReturnsAsync((CleanPattern.Domain.Core.Entities.User)null!);
        ...
        public async Task GetUserAsync_ValidId_ReturnUserDto()
        {
            ...
            CleanPattern.Domain.Core.Entities.User entity = userFaker.Generate();
            Guid id = entity.Id;
